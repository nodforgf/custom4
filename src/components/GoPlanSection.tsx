...
const WISHES = [
  { id: 1,  text: "เค้าอยากไปเที่ยวทะเลกับเก้า",                color: "#ffd6e7" },
  { id: 2,  text: "เค้าอยากไปนอนดูดาวกับเก้า", color: "#fce4ec" },
  { id: 3,  text: "เค้าอยากเดินจับมือ",        color: "#fff0f8" },
  { id: 4,  text: "เค้าอยากให้แฟนนจุ๊บเค้าทั้งวัน",           color: "#ffd6e7" },
  { id: 5,  text: "เค้าอยากกอดให้หายคิดถึง",          color: "#fce4ec" },
  { id: 6,  text: "เค้าอยากไปกินข้าวอร่อยๆกับเก้า",  color: "#fff0f8" },
  { id: 7,  text: "เค้าอยากไปดูพระอาทิตย์ตกกับเก้า",          color: "#ffd6e7" },
  { id: 8,  text: "เค้าอยากไปไหว้เเม่เก้า",         color: "#fce4ec" },
  { id: 9,  text: "เค้าอยากดูแลลเก้าอยากดูแลลเเม่เก้า",            color: "#fff0f8" },
  { id: 10, text: "เค้าอยากไปสวนสนุกกับเก้าาา",            color: "#ffd6e7" },
];
