...
const WISHES = [
  { id: 1,  text: "ไปดูพระอาทิตย์ขึ้นด้วยกัน",                color: "#ffd6e7" },
  { id: 2,  text: "ทำอาหารเย็นด้วยกันสักมื้อ", color: "#fce4ec" },
  { id: 3,  text: "ดูหนังทั้งวันแล้วนอนกอดกัน",        color: "#fff0f8" },
  { id: 4,  text: "ไปเที่ยวทะเลด้วยกัน",           color: "#ffd6e7" },
  { id: 5,  text: "ถ่ายรูปคู่ในโฟโต้บูธ",          color: "#fce4ec" },
  { id: 6,  text: "เขียนจดหมายให้กันและกัน",  color: "#fff0f8" },
  { id: 7,  text: "ไปปิกนิกในสวน",          color: "#ffd6e7" },
  { id: 8,  text: "ดูดาวด้วยกันตอนกลางคืน",         color: "#fce4ec" },
  { id: 9,  text: "ทำลิสต์เป้าหมายในอนาคตด้วยกัน",            color: "#fff0f8" },
  { id: 10, text: "สร้างความทรงจำใหม่ ๆ ทุกเดือน",            color: "#ffd6e7" },
];
