                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>ตั้งแต่วันแรกกที่เจอกันจนถึงวันนี้เค้าไม่เคยรู้สึกกับเก้าหรือรักเก้าน้อยลงมีเเต่เพิ่มขึ้นทุกวันเค้าอยากมีเก้าในทุกวันมีตลอดไปแรกกๆเราอาจจะมีไม่เข้าใจกันเเต่เราก็ปรับกันมาได้เรื่อยๆอาจจะมากหรือน้อยแต่เราก็พยายามกันทั้งคู่เก้าแสดงงให้เค้าเห็นว่าสิ่งที่เก้าเคยพูดว่าจะทำมันไม่วชให้แค่ลมปากเก้าทำมันได้จริงๆเเล้วเก้าดีมากๆเก้าเก่งที่สุดเลยรู้มั้ยใครจะว่าเก้าเป็นยังไงเค้าไม่เคยบอกเก้าไม่ดีเเม้เเต่นิดเดียวเค้าไม่เคยรู้สึกรักใครขนาดนี้มาก่อนเก้าเป็นคนเเรกของหลายๆอย่างของเค้านะเค้ารักเก้ามากๆนะ❤️</p>
                                    </div>
