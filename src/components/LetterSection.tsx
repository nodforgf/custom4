                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>ขอบคุณที่เข้ามาเป็นรอยยิ้ม เป็นความสบายใจ และเป็นคนที่ทำให้ทุกวันธรรมดาของเรามีความหมายมากขึ้น ขอบคุณที่อยู่ข้าง ๆ กันในวันที่มีความสุข และไม่หายไปไหนในวันที่เหนื่อยหรือไม่สดใส</p>
                                        <p>เราอาจไม่ได้สมบูรณ์แบบ แต่ทุกช่วงเวลาที่มีเธออยู่ด้วยทำให้เราอยากเป็นคนที่ดีขึ้นเสมอ ขอบคุณสำหรับความเข้าใจ ความใส่ใจ และความรักเล็ก ๆ น้อย ๆ ที่เธอมอบให้ในทุกวัน</p>
                                        <p>ไม่ว่าจะมีเรื่องราวอีกมากแค่ไหนรออยู่ข้างหน้า เราอยากจับมือเธอไปด้วยกัน ค่อย ๆ สร้างความทรงจำดี ๆ เพิ่มขึ้นทีละวัน และดูแลกันให้นานที่สุดเท่าที่จะทำได้</p>
                                        <p>รักนะ และดีใจเสมอที่มีเธออยู่ในชีวิต 🤍</p>
                                    </div>
